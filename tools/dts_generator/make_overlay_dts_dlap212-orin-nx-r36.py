...
str_fragment_isx021_camera_module0_r364 = """
  ...
  fragment@72 {
    ...
    __overlay__ {
      status = \"okay\";
      pcl_id = \"v4l2_sensor\";
      sysfs-device-tree = \"/sys/firmware/devicetree/base/bus@0/i2c@3160000/tca9546@70/i2c@0/isx021_a@2b\";
    };
  };
"""
...
str_fragment_isx021_camera_module1_r364 = """
  ...
  fragment@74 {
    ...
    __overlay__ {
      status = \"okay\";
      pcl_id = \"v4l2_sensor\";
      sysfs-device-tree = \"/sys/firmware/devicetree/base/bus@0/i2c@3160000/tca9546@70/i2c@0/isx021_b@2c\";
    };
  };
"""
...
str_fragment_isx021_camera_module2_r364 = """
  ...
  fragment@76 {
    ...
    __overlay__ {
      status = \"okay\";
      pcl_id = \"v4l2_sensor\";
      sysfs-device-tree = \"/sys/firmware/devicetree/base/bus@0/i2c@3160000/tca9546@70/i2c@0/isx021_c@2d\";
    };
  };
"""
...
str_fragment_isx021_camera_module3_r364 = """
  ...
  fragment@78 {
    ...
    __overlay__ {
      status = \"okay\";
      pcl_id = \"v4l2_sensor\";
      sysfs-device-tree = \"/sys/firmware/devicetree/base/bus@0/i2c@3160000/tca9546@70/i2c@0/isx021_d@2e\";
    };
  };
"""
...
str_fragment_isx021_camera_module4_r364 = """
  ...
  fragment@80 {
    ...
    __overlay__ {
      status = \"okay\";
      pcl_id = \"v4l2_sensor\";
      sysfs-device-tree = \"/sys/firmware/devicetree/base/bus@0/i2c@3160000/tca9546@70/i2c@1/isx021_e@2b\";
    };
  };
"""
...
str_fragment_isx021_camera_module5_r364 = """
  ...
  fragment@82 {
    ...
    __overlay__ {
      status = \"okay\";
      pcl_id = \"v4l2_sensor\";
      sysfs-device-tree = \"/sys/firmware/devicetree/base/bus@0/i2c@3160000/tca9546@70/i2c@1/isx021_f@2c\";
    };
  };
"""
...
str_fragment_isx021_camera_module6_r364 = """
  ...
  fragment@84 {
    ...
    __overlay__ {
      status = \"okay\";
      pcl_id = \"v4l2_sensor\";
      sysfs-device-tree = \"/sys/firmware/devicetree/base/bus@0/i2c@3160000/tca9546@70/i2c@1/isx021_g@2d\";
    };
  };
"""
...
str_fragment_isx021_camera_module7_r364 = """
  ...
  fragment@86 {
    ...
    __overlay__ {
      status = \"okay\";
      pcl_id = \"v4l2_sensor\";
      sysfs-device-tree = \"/sys/firmware/devicetree/base/bus@0/i2c@3160000/tca9546@70/i2c@1/isx021_h@2e\";
    };
  };
"""
...
str_fragment_i2c_n = """
  fragment@91{
    //cami2c/i2c@0
    target-path = \"/bus@0/i2c@3160000/tca9546@70/i2c@0\";
    __overlay__ {
...
str_i2c_dser_n = """
      dser_0: max96712@48 {
        compatible = \"nvidia,tier4_max96712\";
        reg = <0x4b>;
        status = \"okay\";
        csi-mode = \"2x4\";
        max-src = <4>;
...
str_i2c_ser_n = """
      ...
      max9295_ser_a: max9295_a@31 {
        compatible = \"nvidia,tier4_max9295\";
        reg = <0x31>;
        nvidia,gmsl-dser-device = <&dser_0>;
      };

      max9295_ser_b: max9295_b@32 {
        compatible = \"nvidia,tier4_max9295\";
        status = \"okay\";
        reg = <0x32>;
        nvidia,gmsl-dser-device = <&dser_0>;
...
str_i2c_ser_1 = (
    str_i2c_ser_n
      ...
      .replace("max9295_ser_c", "max9295_ser_g")
      .replace("max9295_ser_d", "max9295_ser_h")
...
str_i2c_isx021_1_p1 = (
    str_i2c_isx021_n_p1.replace("isx021_a@2b", "isx021_b@2c")
    .replace("max9295_ser_a", "max9295_ser_b")
    .replace("reg = <0x2b>", "reg = <0x2c>")
)
str_i2c_isx021_2_p1 = (
    str_i2c_isx021_n_p1.replace("isx021_a@2b", "isx021_c@2d")
    .replace("max9295_ser_a", "max9295_ser_c")
    .replace("reg = <0x2b>", "reg = <0x2d>")
)
str_i2c_isx021_3_p1 = (
    str_i2c_isx021_n_p1.replace("isx021_a@2b", "isx021_d@2e")
    .replace("max9295_ser_a", "max9295_ser_d")
    .replace("reg = <0x2b>", "reg = <0x2e>")
)
str_i2c_isx021_4_p1 = (
    str_i2c_isx021_n_p1.replace("isx021_a@2b", "isx021_e@2b")
    .replace("max9295_ser_a", "max9295_ser_e")
    .replace("&dser_0", "&dser_1")
...
str_i2c_isx021_5_p1 = (
    str_i2c_isx021_n_p1.replace("isx021_a@2b", "isx021_f@2c")
...
str_i2c_isx021_6_p1 = (
    str_i2c_isx021_n_p1.replace("isx021_a@2b", "isx021_g@2d")
...
str_i2c_isx021_7_p1 = (
    str_i2c_isx021_n_p1.replace("isx021_a@2b", "isx021_h@2e")
...
str_i2c_isx021_2_p2 = str_i2c_isx021_n_p2.replace('vc_id = "0"', 'vc_id = "2"')
str_i2c_isx021_3_p2 = str_i2c_isx021_n_p2.replace('vc_id = "0"', 'vc_id = "3"')
str_i2c_isx021_4_p2 = str_i2c_isx021_n_p2.replace(
  "serial_a", "serial_c").replace('lane_polarity = "6"', 'lane_polarity = "0"')
str_i2c_isx021_5_p2 = str_i2c_isx021_n_p2.replace('vc_id = "0"', 'vc_id = "1"').replace(
  "serial_a", "serial_c").replace('lane_polarity = "6"', 'lane_polarity = "0"')
str_i2c_isx021_6_p2 = str_i2c_isx021_n_p2.replace('vc_id = "0"', 'vc_id = "2"').replace(
  "serial_a", "serial_c").replace('lane_polarity = "6"', 'lane_polarity = "0"')
str_i2c_isx021_7_p2 = str_i2c_isx021_n_p2.replace('vc_id = "0"', 'vc_id = "3"').replace(
  "serial_a", "serial_c").replace('lane_polarity = "6"', 'lane_polarity = "0"')
...
str_i2c_isx021_2_p4 = str_i2c_isx021_n_p4.replace(
    'serdes-csi-link = "a"', 'serdes-csi-link = "c"'
).replace("vc-id = <0>", "vc-id = <2>")
str_i2c_isx021_3_p4 = str_i2c_isx021_n_p4.replace(
    'serdes-csi-link = "a"', 'serdes-csi-link = "d"'
).replace("vc-id = <0>", "vc-id = <3>")
str_i2c_isx021_4_p4 = str_i2c_isx021_n_p4
str_i2c_isx021_5_p4 = str_i2c_isx021_n_p4.replace(
    'serdes-csi-link = "a"', 'serdes-csi-link = "b"'
).replace("vc-id = <0>", "vc-id = <1>")
str_i2c_isx021_6_p4 = str_i2c_isx021_n_p4.replace(
    'serdes-csi-link = "a"', 'serdes-csi-link = "c"'
).replace("vc-id = <0>", "vc-id = <2>")
...
str_i2c_1_imx490_isp = (
  str_i2c_imx490_isp_n
  .replace("isp_a", "isp_e")
  .replace("isp_b", "isp_f")
  .replace("isp_c", "isp_g")
  .replace("isp_d", "isp_h")
  .replace("gw5300_a", "gw5300_e")
  .replace("gw5300_b", "gw5300_f")
  .replace("gw5300_c", "gw5300_g")
  .replace("gw5300_d", "gw5300_h")
)
...
str_i2c_imx490_2_p1 = (
    str_i2c_imx490_n_p1.replace("imx490_a@2b", "imx490_c@2d")
    .replace("&max9295_ser_a", "&max9295_ser_c")
    .replace("reg = <0x2b>", "reg = <0x2d>")
    .replace("isp_a", "isp_c")
)
str_i2c_imx490_3_p1 = (
    str_i2c_imx490_n_p1.replace("imx490_a@2b", "imx490_d@2e")
    .replace("&max9295_ser_a", "&max9295_ser_d")
    .replace("reg = <0x2b>", "reg = <0x2e>")
    .replace("isp_a", "isp_d")
)
...
str_i2c_imx490_6_p1 = (
    str_i2c_imx490_n_p1.replace("imx490_a@2b", "imx490_g@2d")
    .replace("&max9295_ser_a", "&max9295_ser_g")
    .replace("reg = <0x2b>", "reg = <0x2d>")
    .replace("isp_a", "isp_g")
    .replace("&dser_0", "&dser_1")
...
str_i2c_imx490_7_p1 = (
    str_i2c_imx490_n_p1.replace("imx490_a@2b", "imx490_h@2e")
    .replace("&max9295_ser_a", "&max9295_ser_h")
    .replace("reg = <0x2b>", "reg = <0x2e>")
    .replace("isp_a", "isp_h")
    .replace("&dser_0", "&dser_1")
...
str_i2c_imx490_2_p2 = str_i2c_imx490_n_p2.replace('vc_id = "0"', 'vc_id = "2"')
str_i2c_imx490_3_p2 = str_i2c_imx490_n_p2.replace('vc_id = "0"', 'vc_id = "3"')
str_i2c_imx490_4_p2 = str_i2c_imx490_n_p2.replace(
  "serial_a", "serial_c").replace('lane_polarity = "6"', 'lane_polarity = "0"')
str_i2c_imx490_5_p2 = str_i2c_imx490_n_p2.replace('vc_id = "0"', 'vc_id = "1"').replace(
  "serial_a", "serial_c").replace('lane_polarity = "6"', 'lane_polarity = "0"')
str_i2c_imx490_6_p2 = str_i2c_imx490_n_p2.replace('vc_id = "0"', 'vc_id = "2"').replace(
  "serial_a", "serial_c").replace('lane_polarity = "6"', 'lane_polarity = "0"')
str_i2c_imx490_7_p2 = str_i2c_imx490_n_p2.replace('vc_id = "0"', 'vc_id = "3"').replace(
  "serial_a", "serial_c").replace('lane_polarity = "6"', 'lane_polarity = "0"')
...
str_i2c_imx490_2_p3 = (
    str_i2c_imx490_n_p3.replace("vc-id = <0>", "vc-id = <2>")
    .replace("csi_in0", "csi_in2")
    .replace("imx490_out0", "imx490_out2")
)
str_i2c_imx490_3_p3 = (
    str_i2c_imx490_n_p3.replace("vc-id = <0>", "vc-id = <3>")
    .replace("csi_in0", "csi_in3")
...
str_i2c_imx490_2_p4 = str_i2c_imx490_n_p4.replace(
    'serdes-csi-link = "a"', 'serdes-csi-link = "c"'
).replace("vc-id = <0>", "vc-id = <2>")
...
str_i2c_imx490_6_p4 = str_i2c_imx490_n_p4.replace(
    'serdes-csi-link = "a"', 'serdes-csi-link = "c"'
).replace("vc-id = <0>", "vc-id = <2>")
...
str_i2c_imx728_1_p1 = (
    str_i2c_imx728_n_p1.replace("imx728_a@2b", "imx728_b@2c")
    .replace("&max9295_ser_a", "&max9295_ser_b")
    .replace("reg = <0x2b>", "reg = <0x2c>")
    .replace("isp_a", "isp_b")
)
str_i2c_imx728_2_p1 = (
    str_i2c_imx728_n_p1.replace("imx728_a@2b", "imx728_c@2d")
    .replace("&max9295_ser_a", "&max9295_ser_c")
    .replace("reg = <0x2b>", "reg = <0x2d>")
    .replace("isp_a", "isp_c")
    .replace("max20089_a", "max20089_b")
...
str_i2c_imx728_3_p1 = (
    str_i2c_imx728_n_p1.replace("imx728_a@2b", "imx728_d@2e")
    .replace("&max9295_ser_a", "&max9295_ser_d")
    .replace("reg = <0x2b>", " reg = <0x2e>")
    .replace("isp_a", "isp_d")
    .replace("max20089_a", "max20089_b")
...
str_i2c_imx728_4_p1 = (
    str_i2c_imx728_n_p1.replace("imx728_a@2b", "imx728_e@2b")
    .replace("&max9295_ser_a", "&max9295_ser_e")
    .replace("isp_a", "isp_e")
    .replace("&dser_0", "&dser_1")
...
str_i2c_imx728_5_p1 = (
    str_i2c_imx728_n_p1.replace("imx728_a@2b", "imx728_f@2c")
    .replace("&max9295_ser_a", "&max9295_ser_f")
    .replace("reg = <0x2b>", "reg = <0x2c>")
    .replace("isp_a", "isp_f")
    .replace("&dser_0", "&dser_1")
...
str_i2c_imx728_6_p1 = (
    str_i2c_imx728_n_p1.replace("imx728_a@2b", "imx728_g@2d")
    .replace("&max9295_ser_a", "&max9295_ser_g")
    .replace("reg = <0x2b>", "reg = <0x2d>")
    .replace("isp_a", "isp_g")
    .replace("&dser_0", "&dser_1")
...
str_i2c_imx728_7_p1 = (
    str_i2c_imx728_n_p1.replace("imx728_a@2b", "imx728_h@2e")
    .replace("&max9295_ser_a", "&max9295_ser_h")
    .replace("reg = <0x2b>", " reg = <0x2e>")
    .replace("isp_a", "isp_h")
    .replace("&dser_0", "&dser_1")
...
str_i2c_imx728_2_p2 = str_i2c_imx728_n_p2.replace('vc_id = "0"', 'vc_id = "2"')
str_i2c_imx728_3_p2 = str_i2c_imx728_n_p2.replace('vc_id = "0"', 'vc_id = "3"')
str_i2c_imx728_4_p2 = str_i2c_imx728_n_p2.replace(
  "serial_a", "serial_c").replace('lane_polarity = "6"', 'lane_polarity = "0"')
str_i2c_imx728_5_p2 = str_i2c_imx728_n_p2.replace('vc_id = "0"', 'vc_id = "1"').replace(
  "serial_a", "serial_c").replace('lane_polarity = "6"', 'lane_polarity = "0"')
str_i2c_imx728_6_p2 = str_i2c_imx728_n_p2.replace('vc_id = "0"', 'vc_id = "2"').replace(
  "serial_a", "serial_c").replace('lane_polarity = "6"', 'lane_polarity = "0"')
str_i2c_imx728_7_p2 = str_i2c_imx728_n_p2.replace('vc_id = "0"', 'vc_id = "3"').replace(
  "serial_a", "serial_c").replace('lane_polarity = "6"', 'lane_polarity = "0"')
...
str_i2c_imx728_2_p3 = (
    str_i2c_imx728_n_p3.replace("vc-id = <0>", "vc-id = <2>")
    .replace("csi_in0", "csi_in2")
    .replace("imx728_out0", "imx728_out2")
)
str_i2c_imx728_3_p3 = (
    str_i2c_imx728_n_p3.replace("vc-id = <0>", "vc-id = <3>")
    .replace("csi_in0", "csi_in3")
...
str_i2c_imx728_2_p4 = str_i2c_imx728_n_p4.replace(
    'serdes-csi-link = "a"', 'serdes-csi-link = "c"'
).replace("vc-id = <0>", "vc-id = <2>")
...
str_i2c_imx728_6_p4 = str_i2c_imx728_n_p4.replace(
    'serdes-csi-link = "a"', 'serdes-csi-link = "c"'
).replace("vc-id = <0>", "vc-id = <2>")
...
def usage():
    ...
    print("** Case 1:                                                                  **")
    print("**                                                                          **")
    print("**  $> make_overlay_dts_dap212-orin-r36.py Rev Camera1 Camera2.. Camera8   **")
    print("**                                                                          **")
    ...
    print("**                                                                          **")
    print("**     E.g.                                                                 **")
    print("**    $> make_overlay_dts_dap212-ori.py R36.4 C1 C1 C2 C2 C3 C3 C1 C1      **")
    print("**             ( Total number of cameras should be 8 )                      **")
    print("** Case 2:                                                                  **")
    print("**                                                                          **")
    print("**  $> make_overlay_dts_dap212-orin-r36.py Options                         **")
    print("**                                                                          **")
    ...
    print("**                                                                          **")
    print("**          $> make_overlay_dts_dap212-orin.py R36.4 -8 C1                 **")
    print("**       2.                                                                 **")
    print("**        2 cameras( port 1,2 ) are C1,                                     **")
    print("**        2 cameras( port 3,4 ) are C2                                      **")
    print("**        4 cameras( port 5,6,7,8 ) are C3                                  **")
    print("**                                                                          **")
    print("**        $> make_overlay_dts_dlap212-orin.py R36.4 -2 C1 -2 C2 -4 C3       **")
    print("**                                                                          **")
    print("******************************************************************************")
...
overlay_dts_file_name = (
    "tier4"
    + str_w_camera_type
    + "-gmsl-device-tree-overlay-dlap212-r"
    + str_fname_rev_num
    + ".dts"
)
